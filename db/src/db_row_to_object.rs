...
pub async fn row_to_user(row: &sqlite::Row) -> types::User {
    types::build_user(
...
pub async fn row_to_organization(row: &sqlite::Row) -> types::Organization {
...
pub async fn row_to_administrator(row: &sqlite::Row) -> types::Administrator {
...
pub async fn row_to_school(row: &sqlite::Row) -> types::School {
    types::build_school(
...
pub async fn row_to_administrator_school(row: &sqlite::Row) -> types::AdministratorSchool {
...
pub async fn row_to_teacher(row: &sqlite::Row) -> types::Teacher {
    types::build_teacher(
...
pub async fn row_to_employee_supervisor(row: &sqlite::Row) -> types::EmployeeSupervisor {
...
pub async fn row_to_teacher_school(row: &sqlite::Row) -> types::TeacherSchool {
...
pub async fn row_to_class(row: &sqlite::Row) -> types::Class {
    types::build_class(
...
pub async fn row_to_student_class(row: &sqlite::Row) -> types::StudentClass {
...
pub async fn row_to_family_user(row: &sqlite::Row) -> types::FamilyUser {
...
pub async fn row_to_family_member(row: &sqlite::Row) -> types::FamilyMember {
...
pub async fn row_to_assignment(row: &sqlite::Row) -> types::Assignment {
...
pub async fn row_to_submission(row: &sqlite::Row) -> types::Submission {
...
pub async fn row_to_comment(row: &sqlite::Row) -> types::Comment {
    types::build_comment(
