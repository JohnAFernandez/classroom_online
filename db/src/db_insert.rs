...
impl I {
    ...
    pub fn insert_organization(
        ...
        let query: String = I::INSERT.to_owned()
            + "organization (name, address1, address2, city, state, zip, phone, country)"
            + I::VALUES_S
            + name
            + I::S_AND_S
            + address1
    ...
    pub fn insert_family(connection: &sqlite::Connection, name: &String) {
        let query: String = I::INSERT.to_owned() + "families (name)" + I::VALUES_S + name + I::S_END;
    ...
    pub fn insert_family_member(
        ...
        let query: String =
            I::INSERT.to_owned() + "family_members (user_id, notification_methods, email, phone)" 
            + I::VALUES + user_id + I::AND_S + notification_methods + I::S_AND_S + email + I::S_AND_S + phone + I::S_END;
